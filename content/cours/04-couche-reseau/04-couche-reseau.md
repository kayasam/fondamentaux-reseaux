...
> - <a href="https://kayasam.github.io/fondamentaux-reseaux/cours/04-couche-reseau/04-couche-reseau-interactif.html" target="_blank">Ouvrir le cours interactif</a>
> - [[cours/04-couche-reseau/tp/01-debutant|TP IPv4 et routage — débutant]]
> - [[cours/04-couche-reseau/tp/02-avance|TP IPv4 et routage — avancé]]
> - [[cours/04-couche-reseau/tp/reseau-avance/01-debutant|TP réseau avancé — débutant]]
> - [[cours/04-couche-reseau/tp/reseau-avance/02-avance|TP réseau avancé — avancé]]

Les trames Ethernet étudiées au chapitre 3 circulent dans un réseau local. Pour atteindre un autre réseau, il faut une adresse logique et des équipements capables de choisir un chemin : c'est le rôle de la **couche réseau**.
...
## 4.1 — Comprendre une adresse IPv4
...
## 4.2 — CIDR, masque et sous-réseaux
...
## 4.3 — VLSM : adapter la taille au besoin
...
## 4.4 — Unicast, broadcast, multicast et ARP
...
> [!NOTE]
> ARP a été détaillé au chapitre 3. Il ne traverse pas les routeurs et ne résout que les adresses du réseau local.
...
## 4.6 — Passerelle et routage statique
...
## 4.7 — Routage dynamique : RIP, OSPF et BGP
...
## 4.9 — IPv6 : adresser durablement les réseaux
...
## 4.10 — MPLS : aperçu d'un réseau opérateur
