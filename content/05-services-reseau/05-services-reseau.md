...
## 5.1 Présentation et Session : rappel rapide
...
## 5.2 DHCP — Attribution automatique d'une configuration IP
...
## 5.4 HTTP et HTTPS — Le web en pratique
...
## 5.5 Autres protocoles applicatifs utiles
